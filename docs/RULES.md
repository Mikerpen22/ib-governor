...
| `futures.daily_loss_stop` | hard | platform_off_today | `futures.daily_loss_usd`<br>`futures.max_losing_trades` | Daily realized loss limit or losing-streak limit hit → platform off for the day. |
